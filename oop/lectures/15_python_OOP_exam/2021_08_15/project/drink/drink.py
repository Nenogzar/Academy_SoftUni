...
class Drink(ABC):
    ...
    def portion(self, value):
        Validation.validation_positive_value(value, "Portion cannot be less than or equal to zero!")
    ...
    def brand(self, value):
        Validation.validate_non_empty_string(value, "Brand cannot be empty string or white space!")
        self.__brand = value
