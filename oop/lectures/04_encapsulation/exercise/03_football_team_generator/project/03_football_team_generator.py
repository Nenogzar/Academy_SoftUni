...
# *******  03_football_team_generator  ******* #
 
# *******  TASK CONDITION  ******* #
"""
https://judge.softuni.org/Contests/1939/Encapsulation-Exercise
Create a separate file for each class as shown below and submit a zip
file containing all files (zip the whole project folder/module)
...
You should create property only for the name of the player.

The class should also have one additional method:
