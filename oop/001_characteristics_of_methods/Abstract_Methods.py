...
Класът, който съдържа абстрактни методи, трябва да наследява от ABC (Abstract Base Class) или 
друга абстрактна базова класа.
"""
...
Всеки клас, който наследява абстрактен клас, трябва да имплементира всички абстрактни методи, 
иначе ще възникне грешка при опит за инстанциране на този клас.
"""
...
Макар че абстрактните методи обикновено нямат имплементация, те могат да имат такава, ако е необходимо.
Наследяващите класове обаче са задължени да предоставят собствена имплементация.
"""
...
Чрез използване на абстрактни методи се гарантира, че всички наследяващи класове предоставят определени методи, 
което улеснява полиморфизма.
