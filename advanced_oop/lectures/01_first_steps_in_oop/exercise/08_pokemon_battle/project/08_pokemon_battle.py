...
Note: For this problem, please submit a zip file,
...
-	release_pokemon(pokemon_name: string)
    o	Check if you have a pokemon with that name and remove it from the collection. In the end, returns
        "You have released {pokemon_name}"
