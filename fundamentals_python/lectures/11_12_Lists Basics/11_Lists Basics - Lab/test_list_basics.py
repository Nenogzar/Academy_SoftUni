...
the
wrong
end! | ['my head is on the wrong end!', 'my body seems on place', 'my tail'] |
...
lists:
• One
with all the positives (including 0) numbers
• One
with all the negatives numbers
Finally, print
the
following
message: < / br >
** Count
of
positives: {count_positives} < / br >
Sum
of
negatives: {sum_of_negatives} **

*Example

| Input | Output |
| ------------------------------------- | ------------------------------------------------------------------------------ |
| 5 < / br > 10 < / br > 3 < / br > 2 < / br > -15 < / br > -4 | [10, 3, 2] < / br > [-15, -4] < / br > Count
of
positives: 3 < / br > Sum
of
negatives: -19 |
...
| Input | Output |
| -------------------------------------------------- | ------------------------------------------------------------------------------------ |
| 6 < / br > 11 < / br > 2 < / br > 35 < / br > 599 < / br > 31 < / br > 20 < / br > | [11, 2, 35, 599, 31,
                                                                                        20] < / br > [] < / br > Count
of
positives: 6 < / br > Sum
of
...
Python
at
SoftUni | ["I study at SoftUni", "I walk to work", "I learn Python at SoftUni"] < / br > ["I study at SoftUni",
                                                                                          "I learn Python at SoftUni"] < / br > |
| 4 < / br > tomatoes < / br > I
love
tomatoes < / br > I
can
...
forever < / br > I
don
't like apples</br>Yesterday I ate two tomatoes | ["I love tomatoes", "I can eat tomatoes forever", "I don'
t
like
apples
", "
...
category(0
counts as a
positive and even).Finally, print
the
result.
