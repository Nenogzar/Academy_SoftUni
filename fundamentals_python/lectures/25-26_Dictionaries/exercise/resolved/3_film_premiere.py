...
if movie_name in movie_info:
    if movie_extra == "Drink":
        price = movie_info[movie_name][0] * movie_tickets
    elif movie_extra == "Popcorn":
        price = movie_info[movie_name][1] * movie_tickets
    elif movie_extra == "Menu":
        price = movie_info[movie_name][2] * movie_tickets
