...
assert doing_python_right_now == True, ("If you see a NameError, it means that the variable is not created and "
                                        "assigned a value. An 'Assertion Error' "
                                        "means that the value of the variable is incorrect.")
